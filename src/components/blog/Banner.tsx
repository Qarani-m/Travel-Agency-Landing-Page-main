...
<div className="block md:flex md:space-x-2 px-2 lg:p-0">
        ...
        >
          ...
          <img src="https://images.unsplash.com/photo-1573790387438-4da905039392?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YmFsaXxlbnwwfHwwfHx8MA%3D%3D" className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" alt="First Example" />
          <div className="p-4 absolute bottom-0 left-0 z-20">
            ...
            <h2 className="text-4xl font-semibold text-gray-100 leading-tight">
              ZPellentesque a consectetur velit, ac molestie ipsum. Donec sodales, massa et auctor.
            </h2>
